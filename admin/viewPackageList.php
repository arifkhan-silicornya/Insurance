...
<!-- ===================================== Right Side Start =========================================
  ...
  <div class="py-2 px-1 border border-primary my-1 mx-auto w-100 d-flex " style="height: auto;">
    ...
    <h3 class="d-flex flex-row justify-content-between">Package List <a href="addnewPackage.php" class="btn btn-outline-primary">Add new</a></h3>
      <table class="table table-light border table-striped">
        ...
        <tr class="text-center">
            ...
            <td>
              <a href="updatePackage.php?Packageid=<?php echo $package_id ;?>" class="btn btn-sm btn-outline-primary">Update</a>
              <a href="php/deletePackage.php?Packageid=<?php echo $package_id ;?>" onclick="return confirm('Disable Package,\n\nDo you Agree?')" class="btn btn-outline-primary btn-sm">Delete</a>
            </td>
          </tr>
          <?php 
          }
          ...
          <tr class="text-center">
            ...
            <td>
              <a href="updatePackage.php?Packageid=<?php echo $package_id ;?>" class="btn btn-sm btn-outline-primary">Update</a>
              <a href="php/activePackage.php?Packageid=<?php echo $package_id ;?>" onclick="return confirm('Active Package,\n\nDo you Agree?')" class="btn btn-outline-primary btn-sm">Do Active</a>
            </td>
          </tr>
          <?php
          }

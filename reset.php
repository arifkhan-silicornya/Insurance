...
<body >
    ...
    <div class="container my-5">
      ...
      <h1 class="text-center text-primary mb-5">Reset Password</h1>
        <form action="php/reset.php" method="POST" name="myForm" onsubmit="return validateForm()">
            <h6 class="text-center font-weight-bold">we will send message to your email</h6>
            <div class="form-group ">
                <input class="form-control border border-primary" type="email" placeholder="Enter Your Email" name="email" required>
            </div>
            <div class="form-group">
...
function validateForm() {
  ...
  if (!email.match(mailformat)) {
    alert("Email must be filled out with @gmail.com");
    return false;
  }
  else{
